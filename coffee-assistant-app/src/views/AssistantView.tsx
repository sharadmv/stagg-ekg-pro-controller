    ...
    <div className="relative flex flex-col h-[calc(100vh-180px)] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full pointer-events-none">
        ...
        <div className="space-y-4 pb-4 pointer-events-auto">
          ...
          {(draftBrew || draftBean) && (
            <div className={`animate-in fade-in slide-in-from-bottom-5 ${draftBean ? 'fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/60 backdrop-blur-sm' : ''}`}>
              <div className={draftBean ? 'w-full max-w-md shadow-2xl' : ''}>
                <BrewDraft
                  draft={draftBrew}
                  draftBean={draftBean}
                  beans={beans}
